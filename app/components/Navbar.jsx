  ...
  return (
    <>
      ...
      >
        ...
        <ul
          className={`hidden md:flex items-center space-x-10 gap-6 lg:gap-8 rounded-full px-12 py-3 ${
            isScroll
              ? ""
        ...
        <ul
          ref={sideMenuRef}
          className="flex md:hidden flex-col gap-4 px-10 py-20 fixed -right-64 top-0 h-screen w-64 z-50 bg-rose-50 transition duration-300 dark:bg-black dark:text-white"
        >
          ...
          <li>
            <a href="#about me" className="font-Ovo" onClick={closeMenu}>
              About
            </a>
          </li>
          <li>
